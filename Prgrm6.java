...
public class Prgrm6 {
	...
	public static void main(String[] args) {
		...
		HashMap<Set<String>, Integer> mappedcombinations = new HashMap<>();
		HashMap<Set<String>, Integer> scanOutput = new HashMap<>();
		int scanCount = 1;
		boolean flag = true;
		while (flag) {
			mappedcombinations = generateCombinations(unique_items, scanCount);
			scanOutput = Scan(transactionSet, mappedcombinations, min_support);
